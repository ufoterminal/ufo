// When these files are hosted apart from the indexer (Vercel, Cloudflare Pages, any static host),
// set window.TALONS_API to the API origin. Served from the Node app itself it stays empty.
