...
// totals are summed across every pool the token trades on: 1250 on the deep pool plus 7 on the other
check("24h volume sums the token's pools", cool && Math.abs(cool.vol24h - 1257) < 0.001, cool ? String(cool.vol24h) : "-");
check("24h txns sums the token's pools", cool && cool.txns24h === 12, cool ? String(cool.txns24h) : "-");
